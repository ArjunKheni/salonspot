...
public class ArCameraModule extends AppCompatActivity implements SurfaceHolder.Callback, AREventListener {
    ...
    private void initializeDeepAR() {
        ...
        deepAR.setLicenseKey("ab95a8f7709954f39c77cfbc3823a4ae0d774f478a08ad537d5e415cc30b7e37101c3983a8585ef8");
    ...
    public void screenshotTaken(Bitmap bitmap) {
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            MediaScannerConnection.scanFile(ArCameraModule.this, new String[]{imageFile.toString()}, null, null);
            Toast.makeText(ArCameraModule.this, "Screenshot saved", Toast.LENGTH_SHORT).show();
        } catch (Throwable e) {
            e.printStackTrace();
        }
